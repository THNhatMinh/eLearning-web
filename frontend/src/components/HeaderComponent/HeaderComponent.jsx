  ...
  return (
    <div className="flex items-center h-[72px] px-6 relative z-100 shadow-md shadow-[#00000059] tabletXs:justify-between">
      ...
      <div
        ...
        onMouseOver={() => handleMouseOver(t("Thể loại"))}
      ...
      <div
        ...
        onMouseOver={() => handleMouseOver(t("Study24"))}
        onMouseLeave={() => handleMouseLeave()}
      >
        <Link to="/my-learning" className="px-3 hover:text-eighth labMd:hidden">
          {t("My Learning")}
        </Link>
        <div
      ...
      <div
        className="relative h-full flex items-center"
        onMouseOver={() => handleMouseOver(t("Giảng dạy trên Study24"))}
        onMouseLeave={() => handleMouseLeave()}
      >
      ...
      <div className="flex h-full">
        ...
        <div
          className="relative h-full flex items-center"
          onMouseOver={() => handleMouseOver(t("Giỏ hàng"))}
          onMouseLeave={() => handleMouseLeave()}
        >
