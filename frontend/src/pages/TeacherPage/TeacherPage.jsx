...
const TeacherPage = () => {
  ...
  const handleNavigate = () => {
    console.log("Navigating to /teacher/coursecreate");
    navigate("/teacher/coursecreate");
  };
  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url(assets/imgs/bg1.webp)",
          height: "600px",
        }}
      >
        <div className="max-w-[1340px] m-auto flex items-center h-full">
          <BoxContent
            ...
            shadow={true}
            bgBox={"bg-seventh"}
            h1={t("Hãy đến giảng dạy với chúng tôi")}
            p={t(
        ...
        <div className="max-w-[1340px] mx-auto mt-12 py-12">
          <div className="flex justify-center">
            <div className="flex flex-col items-center gap-2">
              <h1>{t("Trở thành giảng viên ngay hôm nay")}</h1>
              <p>
                {t(
                  "Tham gia một trong những thị trường học tập trực tuyến lớn nhất thế giới."
                )}
              </p>
              <ButtonComponent
                width={"w-80"}
